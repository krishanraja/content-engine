 ...
 * call site was a bare fetch, so a single 529 failed the route and, on the
 * weekly jobs, the whole week's surfacing.
 *
 * Ported from control-center's api/_retry.ts on 2026-09-19. The control plane
 * moved out of that repo on 2026-09-08 and left this behind, which is why the
 * engine had no retry at all while the dashboard did.
 *
