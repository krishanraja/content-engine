...
for (const file of [...walk('api'), ...walk('lib'), ...walk('scripts')]) {
...
console.log(`PASS  ${used.size} environment variables read by api/, lib/ and scripts/ are all named in .env.example`)
