...
> Replaced by: `README.md`, `docs/NORTH_STAR.md`, `docs/SYSTEM_MAP.md`, `docs/STUDIO.md`
> Reason: described the repository as the Video Studio alone, under the older names Mindmaker and The Money of AI and Built With AI, and never mentioned the content engine in `apps/control-plane`, which has lived here since PR #42 (ADR-019, 2026-09-08).
