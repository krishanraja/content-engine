...
| split.the.bill | Where does the money move, and who ends up better or worse off? | a price, a budget or a contract | Wednesdays, 1 a week |
| lift.the.lid | What actually goes together in a shipped thing, and why did this one work? | what they build or buy | no fixed day, 1 every two weeks |

Krish's own one-line version (2026-09-24, recorded in Control Center's
`NOW.md`): "split.the.bill is how to make money with AI, lift.the.lid is how to
