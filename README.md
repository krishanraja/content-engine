...
The current boundary, workflow and provisional visual system live in [Carousel Engine current state](docs/CAROUSEL_ENGINE_STATE.md). The append-only decision record, the feedback proposals and the visual reset trace are appendices of that document.
